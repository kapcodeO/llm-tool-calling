...
def chat(message, history):
    ...
    responses = client.chat.completions.create(model="gpt-5-nano", messages=messages, tools=tool)
    ...
    if assistant_message.tool_calls:
        ...
        final_response = client.chat.completions.create(model="gpt-5-nano", messages=messages)

        return final_response.choices[0].message.content
    return assistant_message.content

gr.ChatInterface(fn=chat, title="Weather Assistant 🌤️").launch()
